...
class eZFlownInstaller extends eZSiteInstaller
{
    ...
    function initSettings( $parameters )
    {
        ...
        $this->addSetting( 'extension_list', array( strtolower( $this->solutionName() ), 'ezwebin' ) );
        ...
        $siteaccessUrls = array( 'admin'       => $this->createSiteaccessUrls( array( 'siteaccess_list' => array( $this->setting( 'admin_siteaccess' ) ),
                                                                                      ...
                                                                                      'host' => $this->setting( 'admin_access_type_value' ),
                                 ...
                                 'user'        => $this->createSiteaccessUrls( array( 'siteaccess_list' => array( $this->setting( 'user_siteaccess' ) ),
                                                                                      ...
                                                                                      'host' => $this->setting( 'access_type_value' ),
                                                                                      'host_prepend_siteaccess' => false ) ),
...
*/
    ...
    */
    function preInstall()
    {
        ...
        $contentINI->setVariables( array( 'DataTypeSettings' => array( 'ExtensionDirectories' => $datatypeRepositories ) ) );

        $availableDatatype = $contentINI->variable( 'DataTypeSettings', 'AvailableDataTypes' );
        $availableDatatype[] = 'ezpage';
        $contentINI->setVariables( array( 'DataTypeSettings' => array( 'AvailableDataTypes' => $availableDatatype ) ) );
    ...
    function postInstallUserSiteaccessINIUpdate( $params = false )
    {
        ...
        $siteINI->setVariable( "DesignSettings", "AdditionalSiteDesignList", array( 'ezwebin', 'base', 'standard' ) );
        $siteINI->setVariable( "SiteAccessSettings", "RelatedSiteAccessList", $this->setting( 'all_siteaccess_list' ) );
    ...
    function adminSiteINISettings()
    {
        ...
        $settings['ContentSettings'] = array( 'CachedViewPreferences' => array( 'full' => 'admin_navigation_states=0;admin_navigation_content=0;admin_navigation_details=0;admin_navigation_languages=0;admin_navigation_locations=0;admin_navigation_relations=0;admin_navigation_roles=0;admin_navigation_policies=0;admin_navigation_content=0;admin_navigation_translations=0;admin_children_viewmode=list;admin_list_limit=1;admin_edit_show_locations=0;admin_leftmenu_width=10;admin_url_list_limit=10;admin_url_view_limit=10;admin_section_list_limit=1;admin_orderlist_sortfield=user_name;admin_orderlist_sortorder=desc;admin_search_stats_limit=1;admin_treemenu=1;admin_bookmarkmenu=1;admin_left_menu_width=13' ) );
        ...
        $settings = array( 'ViewCacheSettings' => array( 'SmartCacheClear' => 'enabled',
                           ...
                           'article'=> array( 'DependentClassIdentifier' => array( '0' => 'folder',
                                              ...
                                              'ClearCacheMethod' => array( '0' => 'object',
                                                                           '1' => 'parent',
                                                                           '2' => 'relating' ) ),
                           'article_mainpage' => array( 'DependentClassIdentifier' => array( '0' => 'folder',
                                                                                             '1' => 'frontpage' ),
                                                        'ClearCacheMethod' => array( '0' => 'object',
                                                                                     '1' => 'parent',
                                                                                     '2' => 'relating' ) ),
                           'article_subpage' => array( 'DependentClassIdentifier' => array( '0' => 'article_mainpage' ),
                                                       'ClearCacheMethod' => array( '0' => 'object',
                                                                                    '1' => 'parent',
                                                                                    '2' => 'relating',
                                                                                    '3' => 'siblings' ) ),
                           'blog_post' => array( 'DependentClassIdentifier'=> array( '0'=>'frontpage',
                                                                                     '1'=>'blog' ),
                                                 'ClearCacheMethod' => array( '0' => 'object',
                                                                              '1'=>'parent',
                                                                              '2'=>'relating' ) ),
    ...
    function siteMenuINISettings()
    {
        return array( 'name' => 'menu.ini',
                      ...
                      'settings' => array( 'MenuSettings' => array( 'AvailableMenuArray' => array( 'TopOnly',
                                                                                                   ...
                                                                                                   'DoubleTop',
                                                                                                   'LeftTop' ) ),
                                           'SelectedMenu' => array( 'CurrentMenu' => 'DoubleTop',
                                                                    'TopMenu' => 'double_top',
                                                                    'LeftMenu' => '' ),
    ...
    function siteOverrideINISettings()
    {
        return array (
            ...
            'settings' =>
            array (
                'block_2_items1' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/2_items1.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'Manual2Items',
                                                           'view' => '2_items1' ) ),
                'block_2_items2' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/2_items2.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'Manual2Items',
                                                           'view' => '2_items2' ) ),
                'block_main_story1' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/main_story1.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'MainStory',
                                                           'view' => 'main_story1' ) ),
                'block_main_story2' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/main_story2.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'MainStory',
                                                           'view' => 'main_story2' ) ),
                'block_main_story3' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/main_story3.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'MainStory',
                                                           'view' => 'main_story3' ) ),
                'block_3_items1' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/3_items1.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'Manual3Items',
                                                           'view' => '3_items1' ) ),
                'block_3_items2' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/3_items2.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'Manual3Items',
                                                           'view' => '3_items2' ) ),
                'block_3_items3' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/3_items3.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'Manual3Items',
                                                           'view' => '3_items3' ) ),
                'block_4_items1' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/4_items1.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'Manual4Items',
                                                           'view' => '4_items1' ) ),
                'block_4_items2' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/4_items2.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'Manual4Items',
                                                           'view' => '4_items2' ) ),
                'block_4_items3' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/4_items3.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'Manual4Items',
                                                           'view' => '4_items3' ) ),
                'block_5_items1' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/5_items1.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'Manual5Items',
                                                           'view' => '5_items1' ) ),
                'dynamic_3_items1' => array( 'Source' => 'block/view/view.tpl',
                                         ...
                                         'Match' => array( 'type' => 'Dynamic3Items',
                                                           'view' => '3_items1' ) ),
                'block_gallery1' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/gallery1.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'Gallery',
                                                           'view' => 'gallery1' ) ),
                'block_gmap' => array( 'Source' => 'block/view/view.tpl',
                                       'MatchFile' => 'block/gmap.tpl',
                                       'Subdir' => 'templates',
                                       'Match' => array( 'type' => 'GMap',
                                                         'view' => 'gmap' ) ),
                'block_online_users' => array( 'Source' => 'block/view/view.tpl',
                                               'MatchFile' => 'block/online_users.tpl',
                                               'Subdir' => 'templates',
                                               'Match' => array( 'type' => 'OnlineUsers',
                                                                 'view' => 'onlineusers' ) ),
                'block_keyword' => array( 'Source' => 'block/view/view.tpl',
                                          'MatchFile' => 'block/keyword.tpl',
                                          'Subdir' => 'templates',
                                          'Match' => array( 'type' => 'Keyword',
                                                            'view' => 'keyword' ) ),
                'block_multimediacarousel' => array( 'Source' => 'block/view/view.tpl',
                                                     'MatchFile' => 'block/multimediacarousel.tpl',
                                                     'Subdir' => 'templates',
                                                     'Match' => array( 'type' => 'MultimediaCarousel',
                                                                       'view' => 'multimediacarousel' ) ),
                'block_feed_reader' => array( 'Source' => 'block/view/view.tpl',
                                              'MatchFile' => 'block/feed_reader.tpl',
                                              'Subdir' => 'templates',
                                              'Match' => array( 'type' => 'FeedReader',
                                                                'view' => 'feed_reader' ) ),
                'block_video' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/video.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'Video',
                                                           'view' => 'video' ) ),
                'block_itemlist1' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/itemlist1.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'ItemList',
                                                           'view' => 'itemlist1' ) ),
                'block_itemlist1' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/itemlist1.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'ItemList',
                                                           'view' => 'itemlist1' ) ),
                'block_itemlist2' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/itemlist2.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'ItemList',
                                                           'view' => 'itemlist2' ) ),
                'block_itemlist3' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/itemlist3.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'ItemList',
                                                           'view' => 'itemlist3' ) ),
                'block_banner1' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/banner1.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'Banner',
                                                           'view' => 'banner1' ) ),
                'block_banner2' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/banner2.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'Banner',
                                                           'view' => 'banner2' ) ),
                'block_tag_cloud' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/tag_cloud.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'TagCloud',
                                                           'view' => 'tag_cloud' ) ),
                'block_poll' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/poll.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'Poll',
                                                           'view' => 'poll' ) ),
                'block_flash_recorder' => array( 'Source' => 'block/view/view.tpl',
                                         'MatchFile' => 'block/flash_recorder.tpl',
                                         'Subdir' => 'templates',
                                         'Match' => array( 'type' => 'FlashRecorder',
                                                           'view' => 'flash_recorder' ) ),
                ...
                'full_flash_player'=> array( 'Source'=>'node/view/full.tpl',
                                      'MatchFile'=>'full/flash_player.tpl',
                                      'Subdir'=>'templates',
                                      'Match'=> array( 'class_identifier'=>'flash_player' ) ),
                'full_flash_recorder'=> array( 'Source'=>'node/view/full.tpl',
                                      'MatchFile'=>'full/flash_recorder.tpl',
                                      'Subdir'=>'templates',
                                      'Match'=> array( 'class_identifier'=>'flash_recorder' ) ),
