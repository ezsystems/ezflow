...
<p>If you want to get started easily and run your website project, the usual next steps for you might be:</p>

<ol>
    <li><strong>Configure users and permissions</strong> using the administration interface, to grant access and rights to all the team involved in the making of your website. See <a href="http://ez.no/doc/ez_publish/user_manual/4_0/the_administration_interface/the_user_accounts_tab">user manual</a>.</li>
    <li><strong>Customise the layout styles and templates</strong> of your website in order to match your branding requirements. See <a href="http://ez.no/doc/ez_publish/technical_manual/4_x/templates">the documentation</a>.</li>
    <li><strong>Add additional new features</strong> leveraging existing extensions in the ecosystem. See <a href="http://ez.no/doc/ez_publish/technical_manual/4_x/installation/extensions">the documentation</a>.</li>
