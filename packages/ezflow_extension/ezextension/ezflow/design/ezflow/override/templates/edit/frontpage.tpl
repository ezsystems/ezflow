...
function ezajaxSearchPostBack( r )
{
   ...
   */
   ...
   else
   {
       ...
       {
      temp += '<div class="result-item float-break"><div class="item-title">{/literal}<img src={"item-bullet.gif"|ezimage} \/>{literal} ' + search[i].name + '<\/div><div class="item-published-date">[' + search[i].class_name + '] ' + unixtimetodate( search[i].published ) +'<\/div><div class="item-selector"><input type="checkbox" value="' + search[i].id + '" name="SelectedObjectIDArray[]" /><\/div><\/div>';
       }
